...
#'
#' This function pre-filters a table of (sequence) counts using additional information on sample conditions.
...
#' Sequences are kept if both groups have a default minimum average sequence count of 10 or if one of both group has zero counts for all samples.
#' @param count_table The count table generated by \link[DEUS]{createCountTableFromFastQs}
...
#' Function to write summary tables and fasta files for DEUS result
#'
