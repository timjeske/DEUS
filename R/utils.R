...
#' @param expressedOnly If true (default), only sequences with an IHWPvalue are provided in the output file. Sequences without IHWPvalue were not part of the DE analysis and therefore are assumed to have low expression values. If filtering is turned off, output files might include a large number of rows.
...
#' @param clustResult Dataframe containing clustering results as created by \link[DEUS]{runClustering}
...
#'
#' @param cl_sigResults A data frame as created by \link[DEUS]{runDESeq2}. Includes DE pvalues for each cluster
#' @param clustResult Dataframe containing clustering results as created by \link[DEUS]{runClustering}
#' @param sigResults A data frame as created by \link[DEUS]{runDESeq2}. Includes DE pvalues for each individual sequence
#' @param map A data frame with sequences as row names and sequence identifiers in first column.
#' Can be generated by \link[DEUS]{createMap}
