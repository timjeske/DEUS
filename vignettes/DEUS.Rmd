...
### Run example 
To test your setup, you can run our test script that will perform DEUS on our simulated example data. It can also be used as a template for further analyses (See [here](SampleUsage.html))
