...
# call: ./extract_USB_trimming_stats.sh ./trimming <fastq|fq> max_length
...
echo -e "sample\treads\tfrac_adapter\tremoved_shorter_16\tremoved_longer_${ml}\tfrac_quality\tremoved_shorter_16\treads_trimmed" > $stats

for f in $dir/*${fq}.gz_trimming_report.txt; do
